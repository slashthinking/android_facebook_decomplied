...
class CustomConcurrentHashMap$SoftEntry<K, V> extends SoftReference<K>
  implements CustomConcurrentHashMap.ReferenceEntry<K, V>
{
  ...
  CustomConcurrentHashMap$SoftEntry(ReferenceQueue<K> paramReferenceQueue, K paramK, int paramInt, CustomConcurrentHashMap.ReferenceEntry<K, V> paramReferenceEntry)
  {
 ...
 * Qualified Name:     com.google.common.collect.CustomConcurrentHashMap.SoftEntry
