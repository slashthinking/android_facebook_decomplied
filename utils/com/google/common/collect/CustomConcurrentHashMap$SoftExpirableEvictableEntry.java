...
final class CustomConcurrentHashMap$SoftExpirableEvictableEntry<K, V> extends CustomConcurrentHashMap.SoftEntry<K, V>
  implements CustomConcurrentHashMap.ReferenceEntry<K, V>
{
  ...
  CustomConcurrentHashMap$SoftExpirableEvictableEntry(ReferenceQueue<K> paramReferenceQueue, K paramK, int paramInt, CustomConcurrentHashMap.ReferenceEntry<K, V> paramReferenceEntry)
  {
 ...
 * Qualified Name:     com.google.common.collect.CustomConcurrentHashMap.SoftExpirableEvictableEntry
