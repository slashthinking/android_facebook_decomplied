...
final class CustomConcurrentHashMap$WeakEvictableEntry<K, V> extends CustomConcurrentHashMap.WeakEntry<K, V>
  implements CustomConcurrentHashMap.ReferenceEntry<K, V>
{
  ...
  CustomConcurrentHashMap$WeakEvictableEntry(ReferenceQueue<K> paramReferenceQueue, K paramK, int paramInt, CustomConcurrentHashMap.ReferenceEntry<K, V> paramReferenceEntry)
  {
 ...
 * Qualified Name:     com.google.common.collect.CustomConcurrentHashMap.WeakEvictableEntry
