...
class MessagesContactPickerModule$MergedContactPickerListFilterProvider extends AbstractProvider<ContactPickerListFilter>
{
  private ImmutableList<ContactPickerMergedFilter.ContactPickerSubFilterConfig> c()
  {
    ...
    localBuilder.b(new ContactPickerMergedFilter.ContactPickerSubFilterConfig((ContactPickerAddressBookFilter)b(ContactPickerAddressBookFilter.class), ((Resources)b(Resources.class)).getString(2131362514), false));
 ...
 * Qualified Name:     com.facebook.orca.contacts.picker.MessagesContactPickerModule.MergedContactPickerListFilterProvider
