...
public class IsContactsDownloadPermittedProvider
  implements Provider<Boolean>
{
  private static final PrefKey a = GkPrefKeys.a("messenger_contacts_download_android");
  private final OrcaSharedPreferences b;
  private final OrcaAppType c;

  @Inject
  public IsContactsDownloadPermittedProvider(OrcaSharedPreferences paramOrcaSharedPreferences, OrcaAppType paramOrcaAppType)
  {
 ...
 * Qualified Name:     com.facebook.orca.contacts.providers.IsContactsDownloadPermittedProvider
