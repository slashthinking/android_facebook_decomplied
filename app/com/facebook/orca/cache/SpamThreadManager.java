...
public class SpamThreadManager
{
  ...
  public SpamThreadManager(OrcaActivityBroadcaster paramOrcaActivityBroadcaster, Provider<OrcaServiceOperation> paramProvider)
  {
  ...
  public void a(ThreadSummary paramThreadSummary)
  {
    ...
    localOrcaServiceOperation.a(new SpamThreadManager.1(this, str));
    localOrcaServiceOperation.b(true);
    MarkThreadParams localMarkThreadParams = new MarkThreadParams(str, MarkThreadParams.Mark.SPAM, true, paramThreadSummary.b());
 ...
 * Qualified Name:     com.facebook.orca.cache.SpamThreadManager
